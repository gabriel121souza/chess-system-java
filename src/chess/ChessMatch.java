...
public class ChessMatch {
   ...
   public boolean getCheckMate(){
	...
	public boolean[][] possibleMoves(ChessPosition sourcePosition) {
		...
		return (color == Color.Whiter) ? Color.BlACK : Color.Whiter;
	}
    ...
    private void initialSetup(){
        ...
        placeNewPiece('h', 7, new Rook(board, Color.Whiter));
        placeNewPiece('d', 1, new Rook(board, Color.Whiter));
        placeNewPiece('e', 1, new King(board, Color.Whiter));
